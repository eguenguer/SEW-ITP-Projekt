...
public class TrainerPanel extends JPanel {
    ...
    public TrainerPanel(ActionListener controller) {
        this.setLayout(new BorderLayout(10, 10));

        JPanel topPanel = new JPanel(new BorderLayout());
        welcomeLabel.setText("Wort-Trainer");
    ...
    public void enableAntwortEingabe(boolean b) {
        antwortEingabe.setEnabled(b); prüfenButton.setEnabled(b);
    }
